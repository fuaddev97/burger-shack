...
import './App.css'
import RightTopImg from './assets/right-img.jpg'
import LeftTopImg from './assets/left-img.jpg'
import creativeLogo from './assets/burger-shack-creative-logo.jpg'
import TwoBurgers from './assets/two-burgers.jpg'
import TheLine from './assets/the-line.jpg'
import WithFries from './assets/with-fries.jpg'
import WholeMeal from './assets/whole-meal.jpg'
import CheddarBurger from './assets/cheddar-burger.jpg'
import BurgerOfTheDay from './assets/burger-otd.png'
import MakeYourOrder from './assets/make-your-order.jpg'
import Franchise from './assets/franchise.png'
import ArtCollectionOne from './assets/art-collection-one.jpg'
import ArtCollectionTwo from './assets/art-collection-two.jpg'
import GazetteImgOne from './assets/gazette-img-1.jpg'
import GazetteImgTwo from './assets/gazette-img-2.jpg'
  ...
  return (
    <>
      ...
      <section className='top-content'>
        <div className={`left-img ${leftImgVisible ? "left-img-visible" : ""}`}><img src={LeftTopImg} alt="Burger Shack burger with fries"/></div>
      ...
      <div className={`right-img ${rightImgVisible ? "right-img-visible" : ""}`}><img src={RightTopImg} alt='Burger Shack burger'/></div>
      </section>
      ...
      <section className='second-content'>
        <img src={creativeLogo} alt="Burger Shack creative logo" className={`creative-logo ${creativeLogoVisible ? "creative-logo-visible" : ""}`}/>
        <div className={`two-burgers ${twoBurgersVisible ? "two-burgers-visible" : ""}`}>
          <img src={TwoBurgers} alt="Two Burger Shack burgers"/>  
      ...
      <section className="third-content">
        ...
        <div className={`whole-meal ${wholeMealVisible ? "whole-meal-visible" : ""}`}><img src={WholeMeal} alt="Burger Shack burger and fries"/></div>
      </section>
      <section className="fourth-content">
        <div className={`model-burger ${modelBurgerMoveUp ? "model-burger-move-up" : ""}`} ref={modelBurgerRef}>
          <div className="cheddar-burger-img"><span className={`green-curtain ${greenCurtainHidden ? "green-curtain-hidden" : ""}`} ref={greenCurtainRef}></span><img src={CheddarBurger} alt="Cheddar burger with beef patty, cheese, lettuce and tomato"/></div>
      ...
      <section className="fifth-content">
        <h2 className={`story-title ${storyTitleVisible ? "story-title-visible" : ""}`}>
          The Story
          <span>of</span>
          <strong>Burger Shack</strong>
        </h2>
        <div className='make-your-order-container'><span className={`dark-green-curtain-hidden ${darkGreenCurtainCover ? "dark-green-curtain-cover" : ""}`} ref={darkGreenCurtainCoverRef}></span><img src={MakeYourOrder} alt="Burger Shack order your food" className={`make-your-order ${makeYourOrderVisible ? "make-your-order-visible" : ""}`}/></div>
      ...
      <section className="sixth-content">
        
          <img src={Franchise} alt="Burger Shack franchise" className="franchise"/>
      ...
      <section className="seventh-content">
        ...
        <div className="newspaper">
          ...
          <div className='gazette-imgs'>
            ...
            <img src={GazetteImgOne} alt="Burger Shack Gazette news" className='gazette-img-one'/>
            <p>BURGER SHACK CREATES A STIR — Locals Flock In for Today’s Juiciest News</p>
            </div>
            <div className="gazette-two">
            <img src={GazetteImgTwo} alt="Burger Shack Gazette news" className="gazette-img-two"/>
            <p>ANOTHER BURGER DISAPPEARS — Witnesses Blame Unstoppable Appetite</p>
            </div>
          </div>
        </div>
        </div>
